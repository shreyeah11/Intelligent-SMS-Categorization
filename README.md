## 📩 Intelligent SMS Categorization using Machine Learning
...
2️⃣ **Machine Learning** — Model training and prediction  
3️⃣ **Natural Language Processing (NLP)** — Text analysis  
4️⃣ **Scikit-learn** — ML algorithms and evaluation  
5️⃣ **Pandas & NumPy** — Data processing  
6️⃣ **Frontend** — (Optional UI module)  
7️⃣ **Backend** — Model integration and logic  

---

## 📸 Screenshot

[![SMS Categorization UI](assets/screenshot.png)](assets/screenshot.png)  
...
5️⃣ Run the classification script to categorize SS
---
## 🎨 Customization
...
- **Naive Bayes** — Efficient and fast for text-based classification  
- **Logistic Regression** — Probabilistic classification using One-vs-Rest for multi-class SMS categorization  
- **Decision Tree** — Rule-based classification for interpretable results  
- **Support Vector Machine (SVM)** — High-accuracy classification for high-dimensional text data  
